...
# Definición del modelo XONet1
class XONet1(nn.Module):
    def __init__(self, num_classes=10):
        super(XONet1, self).__init__()
...
WEIGHT_DECAY = 0.004
MOMENTUM = 0.9
DATA_DIR = 'dataset/DepthImages_64x64'
...
model = XONet1(num_classes=num_classes).to(device)

# Pérdida y optimizador (según paper)
criterion = nn.CrossEntropyLoss()
optimizer = torch.optim.SGD(model.parameters(), lr=LEARNING_RATE, momentum=MOMENTUM, weight_decay=WEIGHT_DECAY)

# Entrenamiento
print("🧠 Entrenando XONet1 con imágenes de profundidad (config. del paper)...")
...
# Guardar modelo
torch.save(model.state_dict(), 'XONet_DepthImages_64x64.pth')
print("✅ Modelo XONet1 entrenado con profundidad guardado como 'XONet_DepthImages_64x64.pth'")
